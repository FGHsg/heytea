...
//		$url = "https://api.mch.weixin.qq.com/pay/sandboxnew/orderquery";
		//检测必填参数
...
//		$url = "https://api.mch.weixin.qq.com/pay/sandboxnew/closeorder";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet()) {
...
//		$url = "https://api.mch.weixin.qq.com/secapi/pay/sandboxnew/refund";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
...
//		$url = "https://api.mch.weixin.qq.com/pay/sandboxnew/refundquery";
		//检测必填参数
...
//		$url = "https://api.mch.weixin.qq.com/pay/sandboxnew/downloadbill";
		//检测必填参数
...
//		$url = "https://api.mch.weixin.qq.com/pay/sandboxnew/micropay";
		//检测必填参数
...
//		$url = "https://api.mch.weixin.qq.com/secapi/pay/sandboxnew/reverse";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
